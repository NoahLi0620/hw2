...
{
  Book* mp=new Book(prodName_,price_,qty_,isbn_,author_);
	return mp;
...
{
 Clothing* mp=new Clothing(prodName_,price_,qty_,size_,brand_);
	return mp;
...
{
 Movie* mp=new Movie(prodName_,price_,qty_,genre_,rating_);
	return mp;
